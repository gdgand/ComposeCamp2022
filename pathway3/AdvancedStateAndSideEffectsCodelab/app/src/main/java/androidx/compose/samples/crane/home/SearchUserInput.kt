...
import androidx.compose.samples.crane.base.EditableUserInputInputState
import androidx.compose.samples.crane.base.rememberEditableUserInputInputState
...
fun ToDestinationUserInput(onToDestinationChanged: (String) -> Unit) {
    val editableUserInputInputState =
        rememberEditableUserInputInputState(hint = "Destination")
    CraneEditableUserInput(
        state = editableUserInputInputState,
        caption = "To",
        vectorImageId = R.drawable.ic_plane
    )

    val currentOnDestinationChanged by rememberUpdatedState(onToDestinationChanged)
    LaunchedEffect(editableUserInputInputState) {
        snapshotFlow { editableUserInputInputState.text }
            .filter { !editableUserInputInputState.isHint }
            .collect {

        ...
        composable(route = Overview.route) {
            OverviewScreen(
                onClickSeeAllAccounts = {
                    navController.navigateSingleTop(Accounts.route)
                },
                onClickSeeAllBills = {
                    navController.navigateSingleTop(Bills.route)
                },
                onAccountClick = {
        ...
        Scaffold(
            topBar = {
                RallyTabRow(
                    ...
                    onTabSelected = { screen -> navController.navigateSingleTop(screen.route) },

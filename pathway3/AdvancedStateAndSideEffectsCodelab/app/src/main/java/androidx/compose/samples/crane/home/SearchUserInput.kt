...
import androidx.compose.samples.crane.base.rememberEditableUserInputSate
...
fun ToDestinationUserInput(onToDestinationChanged: (String) -> Unit) {
    val editableUserInputState = rememberEditableUserInputSate(hint = "Choose Destination")

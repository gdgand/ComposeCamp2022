...
@Composable
fun OnboardingScreen(modifier: Modifier = Modifier, onContinuedClicked: () -> Unit) {
    ...
    Surface(color = MaterialTheme.colors.primary, modifier = Modifier.padding(vertical = 4.dp, horizontal = 8.dp)) {
        Row(modifier = Modifier.padding(24.dp)) {
            Column(modifier = Modifier
                ...
                if (expanded) {
                    Text(text = ("Compose ipsum color sit lazy, padding theme elit, sed do bouncy. ").repeat(4))
                }
            }

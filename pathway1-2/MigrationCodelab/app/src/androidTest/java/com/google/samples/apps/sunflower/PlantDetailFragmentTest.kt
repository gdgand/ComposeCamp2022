...
class PlantDetailFragmentTest {
    ...
    @Rule
    @JvmField
    val composeTextRule = createAndroidComposeRule(GardenActivity::class.java)
    ...
    fun jumpToPlantDetailFragment() {
        ...
        composeTextRule.activityRule.scenario.onActivity { gardenActivity ->
    ...
    @Test
    fun testPlantName() {
        composeTextRule.onNodeWithText("Apple").assertIsDisplayed()
    }

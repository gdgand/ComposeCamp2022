    ...
    NavHost(
        ...
        composable(route = Overview.route) {
            OverviewScreen(
                ...
                onAccountClick = { type -> navController.navigateToSingleAccount(type) }
            )
        }
...
fun NavController.navigateToSingleAccount(type: String) {
    navigateSingleTopTo("${SingleAccount.route}/$type")
}
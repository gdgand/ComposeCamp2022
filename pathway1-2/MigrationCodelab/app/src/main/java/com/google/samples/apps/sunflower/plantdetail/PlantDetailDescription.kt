...
@Composable
fun PlantDetailDescription(plaintDetailViewModel: PlantDetailViewModel) {
    val plant by plaintDetailViewModel.plant.observeAsState()
    plant?.let { 
...
private fun PlantDetailContentPreview() {
    val plant = Plant("id", "Banana", "HTML<br><br>description", 3, 30, "")
    MdcTheme {

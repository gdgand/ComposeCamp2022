...
import androidx.compose.samples.crane.base.CraneEditableUserInput2
...
@Composable
fun ToDestinationUserInput2(onToDestinationChanged: (String) -> Unit) {
    val editableUserInputState = rememberEditableUserInputState(hint = "Choose Destination")
    CraneEditableUserInput2(

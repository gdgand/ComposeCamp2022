...
fun ToDestinationUserInput(onToDestinationChanged: (String) -> Unit) {
    val userInputState = rememberEditableUserInputState(hint = "Choose Destination")
    val currentOnDestinationChanged by rememberUpdatedState(newValue = onToDestinationChanged)

    LaunchedEffect(userInputState){
        snapshotFlow { userInputState.text }
            .filter{ !userInputState.isHint }
            .collect{

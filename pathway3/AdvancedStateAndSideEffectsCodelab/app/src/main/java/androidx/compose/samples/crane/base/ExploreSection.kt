...
/**
 * Scaffold의 배경에 표시되는 Composable
 * derivedStateOf는 다른 State에서 파생된 Compose State를 원하는 경우에 사용된다.
 * 효율적으로 하기 위해 listState.firstVisibleItemIndex가 변경될 때만 showButton을 계산하는 derivedStateOf
 * API 사용.
  */

...
class PlantDetailFragmentTest {
    ...
    @Rule
    @JvmField
    val composableTestRule = createAndroidComposeRule(GardenActivity::class.java)
    ...
    fun jumpToPlantDetailFragment() {
        ...
        composableTestRule.activityRule.scenario.onActivity { gardenActivity ->
    ...
    @Test
    fun testPlantName() {
        composableTestRule.onNodeWithText("Apple").assertIsDisplayed()

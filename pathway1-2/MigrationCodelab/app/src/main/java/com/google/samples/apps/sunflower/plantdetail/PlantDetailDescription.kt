...
fun PlantDetailContent(plant: Plant) {
    Surface {
        Column(Modifier.padding(dimensionResource(id = R.dimen.margin_normal))) {
            ...
            PlantDescription(descripton = plant.description)
        }
    }
}
...
@Composable
private fun PlantDescription(descripton: String) {
    val htmlDescription = remember(descripton) {
        HtmlCompat.fromHtml(descripton, HtmlCompat.FROM_HTML_MODE_COMPACT)
    }
...
private fun PlantDescriptionPreview() {
    MdcTheme {
        PlantDescription(descripton = "HTML<br><br>description")
    }
}